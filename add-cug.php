...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $bill_unit_no = $_POST['BILL_UNIT_NO'];
    ...
    if (empty($cug_id) || ($name) || ($cug_no) || empty($emp_no) || empty($designation) || empty($unit) || $department == "default" || empty($bill_unit_no) || empty($allocation) || $operator == "default" || empty($plan)) {
