...
<head>
    ...
    <title>Plan Wise Billing Report</title>

    <link rel="icon" type="image/webp" href="logo.webp" />
    <link rel="stylesheet" href="base.css">
    <link rel="stylesheet" href="plan-wise-billing.css">
</head>
    ...
    <main>
        <section id="plan-wise-billing-details">
            ...
            if ($result->num_rows > 0) {
                echo '<table border="1">';
                echo '<tr><th>Plan</th><th>Bill Dates</th><th>Amount</th></tr>';
